...
LUMEX_PUBLIC_API
inline bool
Lumex::Xml::Node::allow_move(XmlNode parent, XmlNode child) // NOLINT(misc-use-internal-linkage)
{
...
LUMEX_PUBLIC_API
inline void
Lumex::Xml::Node::node_output( // NOLINT(misc-use-internal-linkage, readability-function-cognitive-complexity)
...
LUMEX_PUBLIC_API
inline bool
Lumex::Xml::Node::operator&&(XmlNode const &lhs, bool rhs) // NOLINT(misc-use-internal-linkage)
{
  return (bool)lhs && rhs;
}
