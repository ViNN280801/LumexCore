...
public:
  ...
  LUMEX_CONSTEXPR_CTOR explicit Expected(in_place_tag /* unused */, Args &&...args) : m_storage(), m_has_value(true)
  {
  ...
  value() &&
  {
    if(!m_has_value) throw BadExpectedAccess<ErrorType>(std::move(m_storage.m_error)); // Перемещаем ошибку в исключение
  ...
  and_then(FunctionType func) & -> std::invoke_result_t<FunctionType, SuccessType &>
  {
    if(m_has_value) return func(m_storage.m_value);
    return std::invoke_result_t<FunctionType, SuccessType &>(Unexpected<ErrorType>(m_storage.m_error));
  }
#else
  template <typename FunctionType, typename ReturnType = typename std::result_of<FunctionType(SuccessType &)>::type,
  ...
  LUMEX_CONSTEXPR_FUNCTION auto
  and_then(FunctionType func) const & -> std::invoke_result_t<FunctionType, const SuccessType &>
  {
    if(m_has_value) return func(m_storage.m_value);
    return std::invoke_result_t<FunctionType, SuccessType const &>(Unexpected<ErrorType>(m_storage.m_error));
  }
#else
  template <typename FunctionType,
  ...
  template <typename FunctionType>
    requires requires(FunctionType &&f, SuccessType &&val) {
      { std::forward<FunctionType>(f)(std::move(val)) } -> is_expected_concept;
    }
  LUMEX_CONSTEXPR_FUNCTION auto
  and_then(FunctionType func) && -> std::invoke_result_t<FunctionType, SuccessType &&>
  {
    if(m_has_value) return func(std::move(m_storage.m_value));
    return std::invoke_result_t<FunctionType, SuccessType &&>(Unexpected<ErrorType>(std::move(m_storage.m_error)));
  }
#else
  template <typename FunctionType, typename ResultOfFunc = typename std::result_of<FunctionType(SuccessType &&)>::type,
            typename = typename std::enable_if<is_expected<ResultOfFunc>::value>::type>
  LUMEX_CONSTEXPR_FUNCTION auto
  ...
  template <typename FunctionType>
    requires requires(FunctionType &&f, SuccessType &val) {
      { std::forward<FunctionType>(f)(val) } -> std::convertible_to<typename std::remove_cv_t<SuccessType>>;
    } && !std::is_void_v<std::invoke_result_t<FunctionType, SuccessType &>>
             && !is_expected_v<std::invoke_result_t<FunctionType, SuccessType &>>
                LUMEX_CONSTEXPR_FUNCTION auto transform(
                  FunctionType func) & -> Expected<std::invoke_result_t<FunctionType, SuccessType &>, ErrorType>
  {
    if(m_has_value)
      return Expected<std::invoke_result_t<FunctionType, SuccessType &>, ErrorType>(in_place, func(m_storage.m_value));
    return Expected<std::invoke_result_t<FunctionType, SuccessType &>, ErrorType>(
  ...
  template <typename FunctionType>
    requires requires(FunctionType &&f, const SuccessType &val) {
      { std::forward<FunctionType>(f)(val) } -> std::convertible_to<typename std::remove_cv_t<SuccessType>>;
    } && !std::is_void_v<std::invoke_result_t<FunctionType, const SuccessType &>>
             && !is_expected_v<std::invoke_result_t<FunctionType, const SuccessType &>>
                LUMEX_CONSTEXPR_FUNCTION auto transform(FunctionType func)
                  const & -> Expected<std::invoke_result_t<FunctionType, const SuccessType &>, ErrorType>
  {
    if(m_has_value)
      return Expected<std::invoke_result_t<FunctionType, SuccessType const &>, ErrorType>(in_place,
                                                                                          func(m_storage.m_value));
    return Expected<std::invoke_result_t<FunctionType, SuccessType const &>, ErrorType>(
      Unexpected<ErrorType>(m_storage.m_error));
  }
#else
  template <typename FunctionType,
  ...
  template <typename FunctionType>
    requires requires(FunctionType &&f, SuccessType &&val) {
      { std::forward<FunctionType>(f)(std::move(val)) } -> std::convertible_to<typename std::remove_cv_t<SuccessType>>;
    } && !std::is_void_v<std::invoke_result_t<FunctionType, SuccessType &&>>
             && !is_expected_v<std::invoke_result_t<FunctionType, SuccessType &&>>
                LUMEX_CONSTEXPR_FUNCTION auto transform(
                  FunctionType func) && -> Expected<std::invoke_result_t<FunctionType, SuccessType &&>, ErrorType>
  {
    if(m_has_value)
      return Expected<std::invoke_result_t<FunctionType, SuccessType &&>, ErrorType>(
        in_place, func(std::move(m_storage.m_value)));
    return Expected<std::invoke_result_t<FunctionType, SuccessType &&>, ErrorType>(
      Unexpected<ErrorType>(std::move(m_storage.m_error)));
  }
#else
...
#else
  template <
    typename FunctionType, typename ResultOfFunc = typename std::result_of<FunctionType(SuccessType const &&)>::type,
    typename ReturnType = Expected<ResultOfFunc, ErrorType>,
  ...
  template <typename FunctionType>
    requires requires(FunctionType &&f, ErrorType &&err) {
      { std::forward<FunctionType>(f)(std::move(err)) } -> is_expected_concept;
    }
  LUMEX_CONSTEXPR_FUNCTION auto
  or_else(FunctionType func) && -> std::invoke_result_t<FunctionType, ErrorType &&>
  {
  ...
  template <typename FunctionType>
    requires requires(FunctionType &&f, ErrorType &err) {
      { std::forward<FunctionType>(f)(err) } -> std::convertible_to<typename std::remove_cv_t<ErrorType>>;
    } && !std::is_void_v<std::invoke_result_t<FunctionType, ErrorType &>>
             && !is_expected_v<std::invoke_result_t<FunctionType, ErrorType &>>
                LUMEX_CONSTEXPR_FUNCTION auto transform_error(
                  FunctionType func) & -> Expected<SuccessType, std::invoke_result_t<FunctionType, ErrorType &>>
  {
    if(m_has_value)
      return Expected<SuccessType, std::invoke_result_t<FunctionType, ErrorType &>>(in_place, m_storage.m_value);
    return Expected<SuccessType, std::invoke_result_t<FunctionType, ErrorType &>>(
  ...
  template <typename FunctionType>
    requires requires(FunctionType &&f, const ErrorType &err) {
      { std::forward<FunctionType>(f)(err) } -> std::convertible_to<typename std::remove_cv_t<ErrorType>>;
             ...
             && !is_expected_v<std::invoke_result_t<FunctionType, const ErrorType &>>
                LUMEX_CONSTEXPR_FUNCTION auto transform_error(FunctionType func)
                  const & -> Expected<SuccessType, std::invoke_result_t<FunctionType, const ErrorType &>>
  {
    if(m_has_value)
      return Expected<SuccessType, std::invoke_result_t<FunctionType, ErrorType const &>>(in_place, m_storage.m_value);
    return Expected<SuccessType, std::invoke_result_t<FunctionType, ErrorType const &>>(
  ...
  template <typename FunctionType>
    requires requires(FunctionType &&f, ErrorType &&err) {
      { std::forward<FunctionType>(f)(std::move(err)) } -> std::convertible_to<typename std::remove_cv_t<ErrorType>>;
    } && !std::is_void_v<std::invoke_result_t<FunctionType, ErrorType &&>>
             && !is_expected_v<std::invoke_result_t<FunctionType, ErrorType &&>>
                LUMEX_CONSTEXPR_FUNCTION auto transform_error(
                  FunctionType func) && -> Expected<SuccessType, std::invoke_result_t<FunctionType, ErrorType &&>>
  {
    if(m_has_value)
      return Expected<SuccessType, std::invoke_result_t<FunctionType, ErrorType &&>>(in_place,
 ...
 * @deprecated Используйте make_unexpected<E>(...) returning Unexpected<E> and Expected(unexpect_t, ...) вместо этой
 * функции.
 */
