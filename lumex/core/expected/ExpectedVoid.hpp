#ifndef LUMEX_EXPECTED_VOID_HPP
#define LUMEX_EXPECTED_VOID_HPP
    ...
    namespace Expected
    {
      ...
      public:
        ...
        template <typename FunctionType,
                  ...
                  = typename std::result_of<FunctionType()>::type, // Func вызывается без аргументов
        ...
        template <typename FunctionType, typename ReturnType = Expected<void, ErrorType>,
                  typename = typename std::enable_if<std::is_void<
                    typename std::result_of<FunctionType()>::type>::value>::type> // Если func возвращает void
        LUMEX_CONSTEXPR_FUNCTION auto
        ...
        template <typename FunctionType, typename ReturnType = Expected<void, ErrorType>,
                  typename
                  = typename std::enable_if<std::is_void<typename std::result_of<FunctionType()>::type>::value>::type>
        LUMEX_CONSTEXPR_FUNCTION auto
        transform(FunctionType func) const & -> ReturnType
        {
          if(m_has_value)
