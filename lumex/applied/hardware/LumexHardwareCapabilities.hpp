  ...
  namespace Applied
  {
    namespace Hardware
    {
      namespace Constants
      {
        ...
        constexpr const char* KINTEL_CORE2_IDENTIFIER = "Core 2"; ///< Intel Core 2 series identifier
        constexpr const char* KINTEL_I3_2_IDENTIFIER = "i3-2";    ///< Intel i3 2nd gen identifier
        constexpr const char* KINTEL_I5_2_IDENTIFIER = "i5-2";    ///< Intel i5 2nd gen identifier
        constexpr const char* KINTEL_I7_2_IDENTIFIER = "i7-2";    ///< Intel i7 2nd gen identifier
        constexpr const char* KINTEL_I3_3_IDENTIFIER = "i3-3";    ///< Intel i3 3rd gen identifier
        constexpr const char* KINTEL_I5_3_IDENTIFIER = "i5-3";    ///< Intel i5 3rd gen identifier
        constexpr const char* KINTEL_I7_3_IDENTIFIER = "i7-3";    ///< Intel i7 3rd gen identifier
        constexpr const char* KINTEL_I3_4_IDENTIFIER = "i3-4";    ///< Intel i3 4th gen identifier
        constexpr const char* KINTEL_I5_4_IDENTIFIER = "i5-4";    ///< Intel i5 4th gen identifier
        constexpr const char* KINTEL_I7_4_IDENTIFIER = "i7-4";    ///< Intel i7 4th gen identifier
        constexpr const char* KINTEL_I3_6_IDENTIFIER = "i3-6";    ///< Intel i3 6th gen identifier
        constexpr const char* KINTEL_I5_6_IDENTIFIER = "i5-6";    ///< Intel i5 6th gen identifier
        constexpr const char* KINTEL_I7_6_IDENTIFIER = "i7-6";    ///< Intel i7 6th gen identifier
        constexpr const char* KINTEL_I3_8_IDENTIFIER = "i3-8";    ///< Intel i3 8th gen identifier
        constexpr const char* KINTEL_I5_8_IDENTIFIER = "i5-8";    ///< Intel i5 8th gen identifier
        constexpr const char* KINTEL_I7_8_IDENTIFIER = "i7-8";    ///< Intel i7 8th gen identifier
        constexpr const char* KINTEL_I3_10_IDENTIFIER = "i3-10";  ///< Intel i3 10th gen identifier
        constexpr const char* KINTEL_I5_10_IDENTIFIER = "i5-10";  ///< Intel i5 10th gen identifier
        constexpr const char* KINTEL_I7_10_IDENTIFIER = "i7-10";  ///< Intel i7 10th gen identifier

        // AMD CPU identifiers
        constexpr const char* KAMD_RYZEN_IDENTIFIER = "Ryzen";     ///< AMD Ryzen series identifier
        constexpr const char* KAMD_RYZEN_1000_IDENTIFIER = "1000"; ///< AMD Ryzen 1000 series identifier
        constexpr const char* KAMD_RYZEN_2000_IDENTIFIER = "2000"; ///< AMD Ryzen 2000 series identifier
        constexpr const char* KAMD_RYZEN_3000_IDENTIFIER = "3000"; ///< AMD Ryzen 3000 series identifier
        constexpr const char* KAMD_RYZEN_5000_IDENTIFIER = "5000"; ///< AMD Ryzen 5000 series identifier
        constexpr const char* KAMD_RYZEN_7000_IDENTIFIER = "7000"; ///< AMD Ryzen 7000 series identifier

        // GPU detection strings
        constexpr const char* KMICROSOFT_GPU_IDENTIFIER = "Microsoft"; ///< Microsoft GPU driver identifier
        constexpr const char* KBASIC_GPU_IDENTIFIER = "Basic";         ///< Basic render driver identifier
        constexpr const char* KINTEL_GPU_IDENTIFIER = "Intel";         ///< Intel integrated graphics identifier

        // Old CPU family identifiers
        constexpr const char* KOLD_CPU_PENTIUM = "Pentium";    ///< Intel Pentium series identifier
        constexpr const char* KOLD_CPU_CELERON = "Celeron";    ///< Intel Celeron series identifier
        constexpr const char* KOLD_CPU_ATOM = "Atom";          ///< Intel Atom series identifier
        constexpr const char* KOLD_CPU_ATHLON64 = "Athlon 64"; ///< AMD Athlon 64 series identifier
        constexpr const char* KOLD_CPU_PHENOM = "Phenom";      ///< AMD Phenom series identifier
        constexpr const char* KOLD_CPU_SEMPRON = "Sempron";    ///< AMD Sempron series identifier
      }
